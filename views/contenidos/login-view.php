	...
	<div class="login-content">
		...
		<form action="" method="POST" autocomplete="off" >
			<div class="form-group">
				...
				name="usuarioLog" pattern="[a-zA-Z0-9]{1,35}" maxlength="35" required="" >
			</div>
			<div class="form-group">
				<label for="UserPassword" class="bmd-label-floating"><i class="fas fa-key"></i>
				&nbsp; Contraseña</label>
				<input type="password" class="form-control" id="UserPassword"
				name="passwordLog" pattern="[a-zA-Z0-9$@.-]{7,100}" maxlength="100" required="" >
			</div>
...
<?php
	if(isset($_POST['usuarioLog']) && isset($_POST['passwordLog'])){
		...
		$insLogin->loginSesionController();
	}
?>